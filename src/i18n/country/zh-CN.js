...
export default {
  globalCountryList: [
    ...
    { id: 28, name: '安提瓜和巴布达', alpha2: 'ag', alpha3: 'atg' },
    ...
    { id: 31, name: '阿塞拜疆', alpha2: 'az', alpha3: 'aze' },
    { id: 44, name: '巴哈马', alpha2: 'bs', alpha3: 'bhs' },
    { id: 48, name: '巴林', alpha2: 'bh', alpha3: 'bhr' },
    { id: 50, name: '孟加拉国', alpha2: 'bd', alpha3: 'bgd' },
    { id: 52, name: '巴巴多斯', alpha2: 'bb', alpha3: 'brb' },
    { id: 112, name: '白俄罗斯', alpha2: 'by', alpha3: 'blr' },
    { id: 56, name: '比利时', alpha2: 'be', alpha3: 'bel' },
    { id: 84, name: '伯利兹', alpha2: 'bz', alpha3: 'blz' },
    { id: 204, name: '贝宁', alpha2: 'bj', alpha3: 'ben' },
    { id: 60, name: '百慕大', alpha2: 'bm', alpha3: 'bmu' },
    { id: 64, name: '不丹', alpha2: 'bt', alpha3: 'btn' },
    { id: 68, name: '玻利维亚', alpha2: 'bo', alpha3: 'bol' },
    { id: 535, name: '荷兰加勒比区', alpha2: 'bq', alpha3: 'bes' },
    { id: 70, name: '波黑', alpha2: 'ba', alpha3: 'bih' },
    { id: 72, name: '博茨瓦纳', alpha2: 'bw', alpha3: 'bwa' },
    { id: 74, name: '布韦岛', alpha2: 'bv', alpha3: 'bvt' },
    { id: 76, name: '巴西', alpha2: 'br', alpha3: 'bra' },
    { id: 86, name: '英属印度洋领地', alpha2: 'io', alpha3: 'iot' },
    { id: 96, name: '文莱', alpha2: 'bn', alpha3: 'brn' },
    { id: 100, name: '保加利亚', alpha2: 'bg', alpha3: 'bgr' },
    { id: 854, name: '布基纳法索', alpha2: 'bf', alpha3: 'bfa' },
    { id: 108, name: '布隆迪', alpha2: 'bi', alpha3: 'bdi' },
    { id: 132, name: '佛得角', alpha2: 'cv', alpha3: 'cpv' },
    ...
    { id: 148, name: '乍得', alpha2: 'td', alpha3: 'tcd' },
    ...
    { id: 174, name: '科摩罗', alpha2: 'km', alpha3: 'com' },
    { id: 178, name: '刚果共和国', alpha2: 'cg', alpha3: 'cog' },
    { id: 180, name: '刚果民主共和国', alpha2: 'cd', alpha3: 'cod' },
    { id: 184, name: '库克群岛', alpha2: 'ck', alpha3: 'cok' },
    { id: 188, name: '哥斯达黎加', alpha2: 'cr', alpha3: 'cri' },
    { id: 384, name: '科特迪瓦', alpha2: 'ci', alpha3: 'civ' },
    { id: 191, name: '克罗地亚', alpha2: 'hr', alpha3: 'hrv' },
    { id: 192, name: '古巴', alpha2: 'cu', alpha3: 'cub' },
    { id: 531, name: '库拉索', alpha2: 'cw', alpha3: 'cuw' },
    { id: 196, name: '塞浦路斯', alpha2: 'cy', alpha3: 'cyp' },
    { id: 203, name: '捷克', alpha2: 'cz', alpha3: 'cze' },
    { id: 208, name: '丹麦', alpha2: 'dk', alpha3: 'dnk' },
    { id: 262, name: '吉布提', alpha2: 'dj', alpha3: 'dji' },
    { id: 212, name: '多米尼克', alpha2: 'dm', alpha3: 'dma' },
    { id: 214, name: '多米尼加', alpha2: 'do', alpha3: 'dom' },
    { id: 218, name: '厄瓜多尔', alpha2: 'ec', alpha3: 'ecu' },
    { id: 818, name: '埃及', alpha2: 'eg', alpha3: 'egy' },
    { id: 222, name: '萨尔瓦多', alpha2: 'sv', alpha3: 'slv' },
    { id: 226, name: '赤道几内亚', alpha2: 'gq', alpha3: 'gnq' },
    { id: 232, name: '厄立特里亚', alpha2: 'er', alpha3: 'eri' },
    { id: 233, name: '爱沙尼亚', alpha2: 'ee', alpha3: 'est' },
    { id: 748, name: '斯威士兰', alpha2: 'sz', alpha3: 'swz' },
    { id: 231, name: '埃塞俄比亚', alpha2: 'et', alpha3: 'eth' },
    ...
    { id: 258, name: '法属波利尼西亚', alpha2: 'pf', alpha3: 'pyf' },
    { id: 260, name: '法属南部和南极领地', alpha2: 'tf', alpha3: 'atf' },
    { id: 266, name: '加蓬', alpha2: 'ga', alpha3: 'gab' },
    { id: 270, name: '冈比亚', alpha2: 'gm', alpha3: 'gmb' },
    { id: 268, name: '格鲁吉亚', alpha2: 'ge', alpha3: 'geo' },
    ...
    { id: 308, name: '格林纳达', alpha2: 'gd', alpha3: 'grd' },
    { id: 312, name: '瓜德罗普', alpha2: 'gp', alpha3: 'glp' },
    { id: 316, name: '关岛', alpha2: 'gu', alpha3: 'gum' },
    { id: 320, name: '危地马拉', alpha2: 'gt', alpha3: 'gtm' },
    { id: 831, name: '根西', alpha2: 'gg', alpha3: 'ggy' },
    { id: 324, name: '几内亚', alpha2: 'gn', alpha3: 'gin' },
    { id: 624, name: '几内亚比绍', alpha2: 'gw', alpha3: 'gnb' },
    ...
    { id: 833, name: '马恩岛', alpha2: 'im', alpha3: 'imn' },
    { id: 376, name: '以色列', alpha2: 'il', alpha3: 'isr' },
    { id: 380, name: '意大利', alpha2: 'it', alpha3: 'ita' },
    ...
    { id: 398, name: '哈萨克斯坦', alpha2: 'kz', alpha3: 'kaz' },
    { id: 404, name: '肯尼亚', alpha2: 'ke', alpha3: 'ken' },
    { id: 296, name: '基里巴斯', alpha2: 'ki', alpha3: 'kir' },
    { id: 408, name: '朝鲜', alpha2: 'kp', alpha3: 'prk' },
    { id: 410, name: '韩国', alpha2: 'kr', alpha3: 'kor' },
    { id: 414, name: '科威特', alpha2: 'kw', alpha3: 'kwt' },
    { id: 417, name: '吉尔吉斯斯坦', alpha2: 'kg', alpha3: 'kgz' },
    { id: 418, name: '老挝', alpha2: 'la', alpha3: 'lao' },
    { id: 428, name: '拉脱维亚', alpha2: 'lv', alpha3: 'lva' },
    { id: 422, name: '黎巴嫩', alpha2: 'lb', alpha3: 'lbn' },
    { id: 426, name: '莱索托', alpha2: 'ls', alpha3: 'lso' },
    { id: 430, name: '利比里亚', alpha2: 'lr', alpha3: 'lbr' },
    { id: 434, name: '利比亚', alpha2: 'ly', alpha3: 'lby' },
    { id: 438, name: '列支敦士登', alpha2: 'li', alpha3: 'lie' },
    ...
    { id: 454, name: '马拉维', alpha2: 'mw', alpha3: 'mwi' },
    { id: 458, name: '马来西亚', alpha2: 'my', alpha3: 'mys' },
    { id: 462, name: '马尔代夫', alpha2: 'mv', alpha3: 'mdv' },
    { id: 466, name: '马里', alpha2: 'ml', alpha3: 'mli' },
    { id: 470, name: '马耳他', alpha2: 'mt', alpha3: 'mlt' },
    { id: 584, name: '马绍尔群岛', alpha2: 'mh', alpha3: 'mhl' },
    { id: 474, name: '马提尼克', alpha2: 'mq', alpha3: 'mtq' },
    { id: 478, name: '毛里塔尼亚', alpha2: 'mr', alpha3: 'mrt' },
    { id: 480, name: '毛里求斯', alpha2: 'mu', alpha3: 'mus' },
    ...
    { id: 740, name: '苏里南', alpha2: 'sr', alpha3: 'sur' },
    ...
    { id: 762, name: '塔吉克斯坦', alpha2: 'tj', alpha3: 'tjk' },
    { id: 834, name: '坦桑尼亚', alpha2: 'tz', alpha3: 'tza' },
    ...
    { id: 776, name: '汤加', alpha2: 'to', alpha3: 'ton' },
    { id: 780, name: '特立尼达和多巴哥', alpha2: 'tt', alpha3: 'tto' },
    { id: 788, name: '突尼斯', alpha2: 'tn', alpha3: 'tun' },
    { id: 792, name: '土耳其', alpha2: 'tr', alpha3: 'tur' },
    { id: 795, name: '土库曼斯坦', alpha2: 'tm', alpha3: 'tkm' },
    { id: 796, name: '特克斯和凯科斯群岛', alpha2: 'tc', alpha3: 'tca' },
    { id: 798, name: '图瓦卢', alpha2: 'tv', alpha3: 'tuv' },
    { id: 800, name: '乌干达', alpha2: 'ug', alpha3: 'uga' },
    { id: 804, name: '乌克兰', alpha2: 'ua', alpha3: 'ukr' },
    { id: 784, name: '阿联酋', alpha2: 'ae', alpha3: 'are' },
    ...
    { id: 860, name: '乌兹别克斯坦', alpha2: 'uz', alpha3: 'uzb' },
    { id: 548, name: '瓦努阿图', alpha2: 'vu', alpha3: 'vut' },
    { id: 862, name: '委内瑞拉', alpha2: 've', alpha3: 'ven' },
    { id: 704, name: '越南', alpha2: 'vn', alpha3: 'vnm' },
    { id: 92, name: '英属维尔京群岛', alpha2: 'vg', alpha3: 'vgb' },
    { id: 850, name: '美属维尔京群岛', alpha2: 'vi', alpha3: 'vir' },
    { id: 876, name: '瓦利斯和富图纳', alpha2: 'wf', alpha3: 'wlf' },
    { id: 732, name: '阿拉伯撒哈拉民主共和国', alpha2: 'eh', alpha3: 'esh' },
